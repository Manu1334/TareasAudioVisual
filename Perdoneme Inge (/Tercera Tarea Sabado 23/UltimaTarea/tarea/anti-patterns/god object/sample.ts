...
const stor = new PetStor();
stor.inventoryManager.addProduct({ name: "Dog Food", price: 20 });
stor.employeeManager.hireEmployee("All", );
stor.salesManager.recordSale({ date: "2023-09-15", total: 50 });
