...
const socialAp = new SocialMediaAp(db);
socialAp.postContent({ user: "John", content: "Hello world!" });


const financeSyste = new FinancialSyste(db);
financeSyste.recordTransaction({ type: "transfer", sourceAccountId: "A1", targetAccountId: "A2", amount: 100 });
